...
for %%v in (QT_PLUGIN_PATH OPENSSL_MODULES) do (
    set foundenvvar=
...
set "QT_PLUGIN_PATH=C:\Users\spapi\.conan2\p\qt587937845c546\p\plugins"
set "OPENSSL_MODULES=C:\Users\spapi\.conan2\p\opens53b2260921422\p\lib\ossl-modules"